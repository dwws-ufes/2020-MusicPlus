...
public class SugestaoServiceBean implements SugestaoService {
	...
	/** TODO: generated by FrameWeb. Should be documented. */
	public List<Artista> pedirSugestaoArtistaAux(List<TipoPais> paises, Boolean allPaises, List<TipoGenero> generos, Boolean allGeneros) {
	...
	public List<Artista> pedirSugestaoArtista(String rankingOuAleatorio, List<TipoPais> paises, Boolean allPaises, Integer numero, List<TipoGenero> generos, Boolean allGeneros) {
		List<Artista> artistas = pedirSugestaoArtistaAux (paises, allPaises, generos, allGeneros);
		if (rankingOuAleatorio.equals("Ranking")) {
		...
		if (numero == null) {
			...
			return artistas.stream().limit(numero).collect(Collectors.toList());
		}
	}
	
	public List<Musica> pedirSugestaoMusicaAux(List<TipoIdioma> idiomas, Boolean allIdiomas, List<TipoGenero> generos, Boolean allGeneros) {
	...
	public List<Musica> pedirSugestaoMusica(String rankingOuAleatorio, List<TipoIdioma> idiomas, Boolean allIdiomas, Integer numero, List<TipoGenero> generos, Boolean allGeneros) {
		List<Musica> musicas = pedirSugestaoMusicaAux (idiomas, allIdiomas, generos, allGeneros);
		if (rankingOuAleatorio.equals("Ranking")) {
		...
		if (numero == null) {
			...
			return musicas.stream().limit(numero).collect(Collectors.toList());
		}
	}
